 ...
 * digits are taken from the original number in any order.pairs of trailing zeros are
 * zeros are not allowed. Example include: 1260= 21 * 60, 1827 = 21 * 87,
 * 2187 = 27 * 81. write a program that finds all the 4-digits vampire numbers.
